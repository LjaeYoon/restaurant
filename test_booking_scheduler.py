...
def test_시간대별_인원제한이_있다_같은_시간대가_다르면_Capacity_차있어도_스케줄_추가_성공(booking_scheduler):
    # arrange
    schedule = Schedule(ON_THE_HOUR, CAPACITY_PER_HOUR, CUSTOMER)
    booking_scheduler.add_schedule(schedule)
    # act
...
def test_예약완료시_SMS는_무조건_발송됨(booking_scheduler, booking_scheduler_with_sms_mock):
    # arrange
